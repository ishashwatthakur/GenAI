...
export default function Home() {
  ...
  return (
    ...
    CTA SECTION
------------------------ّ */}
<section className="relative w-full py-20 px-6 z-50">
  <div className="max-w-4xl mx-auto text-center">
    ...
    <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-6">
      <button
        onClick={() => {
          ...
          if (section) {
            ...
            console.log('uploadSectionRef not found'); // Debug log
          }
        }}
        className="px-12 py-5 bg-gradient-to-r from-purple-600 to-pink-600 rounded-full font-bold text-xl text-white shadow-2xl hover:shadow-purple-500/50 transition-all duration-300 hover:scale-105 active:scale-95 cursor-pointer z-50 relative"
      >
        Start Free Analysis
      </button>
      ...
      <button
        onClick={() => {
          console.log('Drafter button clicked!'); // Debug log
          router.push('/drafter');
        }}
        className="px-12 py-5 bg-gradient-to-r from-green-600 to-emerald-600 rounded-full font-bold text-xl text-white shadow-2xl hover:shadow-green-500/50 transition-all duration-300 hover:scale-105 active:scale-95 cursor-pointer z-50 relative"
      >
