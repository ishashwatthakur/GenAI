          ...
          <div className="flip-container-wrapper">
            <div style={{ pointerEvents: 'auto', position: 'relative', zIndex: 1000 }}>
              <RegionSelector onSelect={(jurisdiction) => {
                ...
                // This will be used in handleGenerate for the API call
              ...
              <div className="relative">
                ...
                >
                  <textarea
                    ...
                    className="flex-1 resize-none outline-none text-gray-900 placeholder-gray-400 bg-transparent text-sm md:text-base leading-6 max-h-[200px] overflow-y-auto"
                    style={{ 
                      minHeight: '28px',
                      scrollbarWidth: 'thin',
